...
root.geometry('506x390')
root.configure(bg='#2B547E')
root.resizable(width=0, height=0)

label = Label(root, text="WHATSAPP", font="bold",
              width=42, fg="white", bg="black", padx=10, pady=13)
...
label = Label(
    root, text="WhatsApp Number: Country code", font=10, fg="white", bg="black")
label.grid(row=1, padx=10, pady=10)
label.place(x=10,
            y=90)
number_str = StringVar()
entry1 = (Entry(root, width=43, textvariable=number_str,
                bd=6, font=14, borderwidth=6))
entry1.insert(0, "+")
entry1.grid(row=1, column=1, columnspan=1, padx=10, pady=43)
...
entry2 = (Entry(root, width=43, textvariable=message_str,
                bd=6, font=14, borderwidth=6))
...
send = Button(root, font="30", width=42, text="Send",
